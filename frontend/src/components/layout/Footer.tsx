      ...
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-8 group">
              ...
              <span className="text-2xl font-serif tracking-[0.2em] text-white italic">SSP ESTATES</span>
            </Link>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 group cursor-pointer hover:text-gold-500 transition-colors">
              ...
              <span className="text-gray-300 font-light">contact@sspestates.com</span>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-12 flex flex-col md:flex-row justify-between items-center gap-8">
          <p className="text-gray-600 uppercase text-[9px] tracking-[0.4em] font-bold">
            &copy; {new Date().getFullYear()} SSP ESTATES INTERNATIONAL. ALL RIGHTS RESERVED.
          </p>
